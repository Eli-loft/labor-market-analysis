...
Data Sources
DatasetSourceAccessBLS Employment Situation (PAYEMS, CE16OV, UNRATE, U6RATE, CIVPART, LNS12300060, CLF16OV)Federal Reserve Bank of St. Louis FREDFRED APIFederal Reserve Monetary Data (M2SL, WALCL, CPIAUCSL, MEPAINUSA672N)Federal Reserve / Census Bureau via FREDFRED APIBLS Annual Benchmark RevisionsBLS benchmark revision press releasesManually compiled
...
Setup
bashpip install plotly pandas numpy fredapi
Run the interactive script:
bashpython src/data_viz_interactive.py
